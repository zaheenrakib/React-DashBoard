...
const Sidebar = () => {
    return (
        <div>
            <div className='w-[250px] h-full bg-slate-200'>
                <div className='w-full flex justify-center items-center'>
                    <IoSunnyOutline className='text-4xl mt-4 text-blue-300' />
                    <h1 className='text-2xl mt-4 font-extrabold'><span className='text-blue-300 font-semibold'>On</span>Course</h1>
                </div>

                <ul>

                    <div className='flex  flex-col gap-y-72 mt-8 p-2 text-black'>
